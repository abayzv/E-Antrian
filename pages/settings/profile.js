...
export default function Profile() {
    ...
    const submitHandler = async (e) => {
        ...
        try {
            ...
            toaster.notify(`The profile has been updated ${form.email !== authUser.contents.email && 'and you need to verify your email address.'}`, {
    ...
    return (
        <Layout middleware="auth" title="Update Profile Information">
            <Container>
                ...
                <Card header={
                    <>
                        <h1 className="font-semibold text-xl">Update Profile Information</h1>
                    ...
                    <form onSubmit={submitHandler}>
                        ...
                        <div className="grid grid-cols-2 gap-x-4">
                            <div className="mb-6">
                                ...
                                {errors && errors.username && <Error message={errors.username} />}
                            </div>
                            <div className="mb-6">
