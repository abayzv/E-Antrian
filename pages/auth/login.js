                    ...
                    <form onSubmit={submitHandler}>
                        ...
                        <div className="mb-5 flex items-center justify-between">
                            <div className="flex items-center">
                                <input value={form.remember} onChange={(e) => setForm(form => ({ ...form, remember: e.target.value }))} type="checkbox" name="remeber" id="remember" className="form-checkbox shadow-sm border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200 transition duration-200 rounded" />
                                <label htmlFor="remember" className="ml-2">Remember</label>
                            </div>
